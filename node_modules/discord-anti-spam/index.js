 ...
 * @property {string|RichEmbed|MessageEmbed} [kickMessage='{@user} has been added to the ignore list for spamming.'] Message that will be sent in chat upon kicking a user.
...
const clientOptions = {
	...
	kickMessage: '{@user} has been added to the ignore list for spamming.',
...
class AntiSpam extends EventEmitter {
	...
	async message(message) {
		...
		const kickUser = async () => {
			...
			// fs.writeFileSync(path, JSON.stringify(ignoreList));
