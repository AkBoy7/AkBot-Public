...
const points = require("./commands/akbotapp.js");
...
const event = require("./commands/akbotapp.js");
const bet = require("./commands/akbotapp.js");
const wordle = require("./commands/akbotapp.js");
...
module.exports = async function (msg) {
  ...
  if (
    msg.channel.type == "dm" &&
    !(msg.author.username === "AkBoy" || msg.author.username === "AkBot")
  ) {
  ...
  try {
    if (
      !(checkRole("Board", msg) || checkRole("Moderator", msg)) &&
      !msg.author.bot
    ) {
      ...
      if (msgContainsBadWord) {
        ...
        botChannel.send(
          "Detected potential offensive message at: <#" +
            msg.channel.id +
            ">, from <@" +
            msg.author.id +
            ">.\n" +
